        ...
        <div class="container py-vh-4 position-relative mt-5 px-vw-5 text-center">
            <div class="row d-flex align-items-center justify-content-center py-vh-5">
                <div class="col-12 col-xl-10">
                    <span class="h5 text-secondary fw-lighter">{{ __('layout.goals') }}</span>
                    <h1 class="display-huge mt-3 mb-3 lh-1">{{ __('layout.slogan') }}</h1>
                </div>
                <div class="col-12 col-xl-8">
                    <p class="lead text-secondary">{{ __('layout.teaser') }}</p>
                </div>
                <div class="col-12 text-center">
                    <a href="#" class="btn btn-xl btn-light">{{ __('layout.join') }}</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container px-vw-5 py-vh-5">
            <div class="row d-flex align-items-center">
                <div class="col-12 col-lg-7 text-lg-end" data-aos="fade-right">
                    <span class="h5 text-secondary fw-lighter">Koncept</span>
                    <h2 class="display-4">Fakturkowo to w pełni darmowa aplikacja, pozwalająca na darmowe generowanie faktur. Zaloguj się i korzystaj z wielu funkcjonalności.</h2>
                </div>
                <div class="col-12 col-lg-5" data-aos="fade-left">
                    <h3 class="pt-5">Panel użytkownika</h3>
                    <p class="text-secondary">Po zalogowaniu otrzymasz dostęp do panelu z wieloma funkcjonalnościami tj. historia wygenerowanych faktur, statystyki o danym miesiącu czy sumę faktur w konkretnym okresie.<br>
                        <a href="#" class="link-fancy link-fancy-light me-2">Dowiedz się więcej</a>
                    </p>
                    <h3 class="border-top border-secondary pt-5 mt-5">Wsparcie i rozwój</h3>
                    <p class="text-secondary">Aplikacja rozwijana jest hobbystycznie o potrzeby uzytkowników. Własny pomysł na dodatkowe funkcjonalności możesz wysłać używając zakładki "Postaw mi kawę".<br>
                        <a href="#" class="link-fancy link-fancy-light me-2">Dowiedz się więcej</a>
                    </p>
                </div>
            </div>
                    ...
                    <div class="col-6 d-flex align-items-center bg-dark shadow rounded-5 p-0" data-aos="zoom-in-up">
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-12 col-lg-10 col-xl-8 text-center my-5">
                                <p class="lead border-bottom pb-4 border-secondary">"Szczere podziękowania dla naszych użytkowników za wybór tej aplikacji. Wasze zaangażowanie i wsparcie są nieocenione i motywują mnie do dalszego rozwoju produktu, aby spełniał Wasze oczekiwania w najwyższym stopniu. Dziękuję, że jesteście częścią tej społeczności."</p>
                                <p class="text-secondary text-center">Konrad Konarski, CEO</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-5 offset-1">
                        <span class="h5 text-secondary fw-lighter">Statystyki</span>
                        <h2 class="display-huge fw-bolder" data-aos="zoom-in-left">+400</h2>
                        <p class="h4 fw-lighter text-secondary">
                            Tylu użytkowników korzysta z aplikacji.
                        </p>

                        <h2 class="display-huge fw-bolder border-top border-secondary pt-5 mt-5" data-aos="zoom-in-left">78.981</h2>
                        <p class="h4 fw-lighter text-secondary">
                            Łącznie wygenerowanych faktur na Fakturkowo.
                        </p>
